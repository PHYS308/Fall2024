...
Each unit (except for the unit on quantum weirdness) will have three problems similar to what we work on in class, but larger in scope and/or difficulty. These problems will be due shortly after the unit is over, and will be graded on completion. These problems create the foundation of 
...
There will be one midterm and one final, which will be given during the scheduled final exam time.

These are graded on an [E/M/U/N scale](#emun),

#### Presentations {#presentations}

After every unit, you will have a chance to present one of the problems to the class in a group of up to three. You will be graded on the correctness and completeness of the solution, 
