...
Welcome to the Fall 2024 class of PHYS 308!
...
Bates College does not have an official land acknowledgment, but I felt it was important to include one as a person who lives, and works on these stolen lands. A land acknowledgment is only a start, and should not be seen as absolving those who benefit from responsibility. For more, see [this excellent article in The Bates Student](https://thebatesstudent.com/18429/news/does-bates-deserve-a-land-acknowledgement/)
...
You can see the PHYS 308 course description [here](https://phys308.github.io/).

## Course Objectives

By the end of this course, you will be able to

-   Relate the concepts of quantum mechanics to the mathematics through Dirac notation
-   Understand the behavior of quantum particles under the influence of different types of potentials
-   Calculate measurements of properties like spin and energy
-   Translate between different basis states
-   Understand the mathematical basis for quantum paradoxes like Schrödinger's cat and the Einstein-Podolsky-Rosen Paradox
